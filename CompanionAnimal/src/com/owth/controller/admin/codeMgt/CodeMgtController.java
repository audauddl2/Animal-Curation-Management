...
public class CodeMgtController {
	...
	*/
	...
	//용도 명칭 수정
		@RequestMapping("/codeManagement/useCodeUpdateAction")
		 public String useCodeUpdateAction(ModelMap modelMap, @ModelAttribute CodeMgtVO CodeMgtVO, HttpServletRequest request, Writer out) throws ServiceException{
			...
			try{
				...
				System.out.println("용도 수정 시작");
				codeMgtService.useCodeUpdate(CodeMgtVO);
				System.out.println("용도 수정 완료");
				return "/codeManagement/ingredientCodeManagement";
