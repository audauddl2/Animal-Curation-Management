...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../views/resources/css/mobile/useSearch_1.css"/>
					...
					<div class="showArea">
						...
						<div class="btnWrap">
							<ul class="selectBtnOne">
								<li class="menuDown"><a class="btnText one" href="#none">입맛 없을 때용</a></li>
								
								<ul class='menuSub'>
									<li><a class="btnText" href="/MUseSearch/useSearch_2">보상용</a></li>
									<li><a class="btnText" href="/MUseSearch/useSearch_3">스트레스 해소용</a></li>
									<li><a class="btnText" href="/MUseSearch/useSearch_4">치아 관리용</a></li>
								</ul>
							</ul>
						...
						<!-- 해당영역 반복문 -->
						<!-- productInfo -->
						<button class="productInfo" onclick="location.href='/MProductInfo/productInfo_1'">
