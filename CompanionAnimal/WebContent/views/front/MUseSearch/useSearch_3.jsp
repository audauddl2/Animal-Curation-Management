...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../views/resources/css/mobile/useSearch_3.css"/>
					...
					<div class="showArea">
						...
						<div class="btnWrap">
							<ul class="selectBtnOne">
								<li class="menuDown"><a class="btnText one" href="#none">스트레스 해소용</a></li>
								
								<ul class='menuSub'>
									<li><a class="btnText" href="/MUseSearch/useSearch_1.html">입맛 없을 때용</a></li>
									<li><a class="btnText" href="/MUseSearch/useSearch_2.html">보상용</a></li>
									<li><a class="btnText" href="/MUseSearch/useSearch_4.html">치아 관리용</a></li>
								</ul>
							</ul>
