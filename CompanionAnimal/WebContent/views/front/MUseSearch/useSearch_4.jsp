...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../views/resources/css/mobile/useSearch_4.css"/>
					...
					<div class="showArea">
						...
						<div class="btnWrap">
							<ul class="selectBtnOne">
								<li class="menuDown"><a class="btnText one" href="#none">치아 관리용</a></li>
								
								<ul class='menuSub'>
									<li><a class="btnText" href="/MUseSearch/useSearch_1">입맛 없을 때용</a></li>
