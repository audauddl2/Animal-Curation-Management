...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../views/resources/css/mobile/F&Q_1.css"/>
				...
				<div class="innerBox">
					<div class="showArea">
						...
						<div class="FQList">
							...
							<!-- script 작접시 수정-->
							<div class="FQListChoice">
								<div class="FQListChoiceWrap">
									<p class="FQListText">[F&Q] text</p>
