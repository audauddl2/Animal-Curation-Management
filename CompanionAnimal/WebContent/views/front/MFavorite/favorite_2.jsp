...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../views/resources/css/mobile/favorite_2.css"/>
            ...
            <div id="contents">
                ...
                <div class="innerBox">
					...
					<div class="showArea"> 
						...
						<!-- brandInfo -->
						<div class="brandInfo">
							<button class="brandInfoArea" onclick="location.href='/MBrandSearch/brandSearch_1'">
								<div class="iconBrand"></div>
								<!-- 상품 이지지 추가 시 변경
