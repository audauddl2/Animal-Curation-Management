...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../views/resources/css/mobile/favoriteUser_1.css"/>
						...
						<div class="petInfo">
							<div class="petInfoArea">
								...
								<div class="infoText">
									...
									<p class="petType">품종/나이/건강특성/기호식품(등의 정보)</p>
									<p class="reviewCnt">작성리뷰 수 <span style="color:#5184FF;">5</span> 개</p>					
								</div>
								<img class="iconBmrk"src="../../views/resources/img/icon_bookmark_checked.png">								
							</div>
						</div>
