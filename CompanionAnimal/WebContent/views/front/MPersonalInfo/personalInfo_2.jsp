...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../views/resources/css/mobile/personalInfo_2.css"/>
            ...
            <div id="contents">
                ...
                <div class="innerBox">
					...
					<div class="showArea"> 
						...
						<div class="btnWrap">
							<div class="infoBtn">
								<a class="infoText" href="MPersonalInfo/personalInfo_1">이용약관</a>
							</div>
							<div class="borderBar"></div>
							<div class="personBtn">
								<a class="personText" href="MPersonalInfo/personalInfo_2">개인정보 취급방침</a>
							</div>
						</div>				
