			...
			<form class="InnerContent" action="/ingredientRST/ingredientSearch" method="post">
				...
				<div class="InnerTable1">
					...
					<div class="serchArea" style="position:relative; float:left; width:98%; height:30px; margin:5px 10px 5px 10px;">
						...
						<input type="text" name="word" value="${word}"style="padding-left:6px;height:24px;line-height:24px;border:1px solid #dbdbdb; position:relative; float:left; width:500px;" placeholder="내용을 입력해 주세요">
								...
								<tr>
									...
									<td>
										<div style="position:relative; float:left; margin:0 0 0 10px;">
											<!-- 시작일 -->
											<span class="dset">
												<input type="text" class="datepicker inpType" name="searchStartDate" value="${searchStartDate}" id="searchStartDate" placeholder="기간을 선택하세요">
												
											</span>
											<span class="demi">~</span>
											<!-- 종료일 -->
											<span class="dset">
												<input type="text" class="datepicker inpType" name="searchEndDate" value="${searchEndDate}" id="searchEndDate" placeholder="기간을 선택하세요">
				...
				<div class="InnerTable2" style="width:100%, height:200px; overlfow:auto;">
			   		<table style="width:100%; cellspacing:0; cellpadding:0;">
				        ...
				        <tbody style="color:#666; text-align:center;">			
					        <c:choose>
	                			<c:when test="${fn:length(getIngredientSearchList) > 0}" > 	        	
				        			<c:forEach items="${getIngredientSearchList}" var="getList" varStatus="status">
			        					<tr>
							        		<td>${status.count}</td>					        		
