...
<script>
	$(document).ready(function(){
		$("#btnUpdate").click(function(){
			...
			document.form1.action="/update?flag=co";
		...
		<div class="InnerContent">
			<div style="background-color:#E6E7E8; height:970px">
				<form name="form1" method="post">
					<div>
						<div>
							제목 <input type="text" name="bbsTitle" id="bbsTitle" value="${columnUpdate.bbsTitle }" maxlength="50" style="width: 600px;">
						</div>
						<div>
							내용<textarea name="columnContent" id="columnContent" cols="72" rows="3" maxlength="2048">${columnUpdate.bbsContent }</textarea>
						</div>
						<div>
							작성자 <input type="text" name="writer" id="writer" value="${columnUpdate.writer }" maxlength="50" style="width: 600px;">
						</div>
						<input type="hidden" name="bbsIdx" value="${columnUpdate.bbsIdx }">
