							...
							<div style="text-align:center; margin:10px 15px 0 0;">
								...
								<div class="form-popup" id="myForm1">
									<div class="form-container">
						        		...
						        		<p>위험도 추가</p>
						        		<input type="text" placeholder="추가할 위험도 이름을 쓰시오" name="dangerName" style="width:275px;">	
										...
										<c:choose>
				                			<c:when test="${fn:length(getUseCodeCntList) > 0}" > 	        	
							        			<c:forEach items="${getUseCodeCntList}" var="getUseCodeCntList" varStatus="status">
										        		...
										        		<form action="/codeManagement/useCodeUpdateAction" method="post">
										        			<input type="hidden" name="codeIdx" value="${getUseCodeList[status.index].codeIdx}">
										        			<input type="text" name="codeName" placeholder="수정할 용도 이름을 쓰시오">
										        			<input class="btn" type="submit" value="수정">
										        			<input class="btn cancel" type="submit" value="삭제">
										        		</form>
										        		<!--
