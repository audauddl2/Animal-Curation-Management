...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../../views/resources/css/mobile/materialSearch_3.css"/>
					...
					<div class="showArea">
						...
						<div class="btnWrap">							
							...
							<ul class="selectBtnOne">
								<li class="menuDown one"><a class="btnText" href="#none">비육어류</a></li>
								
								<ul class='menuSub'>
									<li><a class="btnText" href="MMaterialSearch/materialSearch_1">육류</a></li>
									<li><a class="btnText" href="MMaterialSearch/materialSearch_2">어류</a></li>
								</ul>
							</ul>
						...
						<div class="materialWrap">
							...
							<div class="sliderbox">							
								<ul>
									<li class="slideCon"><img class="btnImg" src="../../views/resources/img/main/main_2_16.png"> <div class="borderBar"></div></li>
									<li class="slideCon"><img class="btnImg" src="../../views/resources/img/main/main_2_17.png"> <div class="borderBar"></div></li>
									<li class="slideCon"><img class="btnImg" src="../../views/resources/img/main/main_2_18.png"> <div class="borderBar"></div></li>
									<li class="slideCon"><img class="btnImg" src="../../views/resources/img/main/main_2_19.png"> <div class="borderBar"></div></li>
									<li class="slideCon"><img class="btnImg" src="../../views/resources/img/main/main_2_19.png"> <div class="borderBar"></div></li>
								</ul>								
							</div>
