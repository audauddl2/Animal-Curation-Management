		...
		<div class="InnerContent">
			<div style="background-color:#E6E7E8; height:970px">
				<table>
					<tbody>
						...
						<tr>
							<th>작성자</th>
							<td>${columnDetail.writer}</td>
						</tr>
						<tr>
							<th>작성시간</th>
							<td>${columnDetail.writeDate}</td>
						</tr>
						<tr>
							<th>내용</th>
							<td>${columnDetail.bbsTitle}</td>
						</tr>
						<tr>
							<td>${columnDetail.bbsContent}</td>
						</tr>
					</tbody>
				</table>
			
				<a href="/bbsList?flag=co"><input type="button" value="목록으로"/></a>
				
				<a href="/board/column/columnUpdate?bbsIdx=${columnDetail.bbsIdx}">
					<input type="button" name="columnUpdate" value="수정"/></a>
			...
			<!-- 	
				...
				function fn_openColumnUpdate() {
					var bbsIdx = "${columnDetail.bbsIdx}";
					var comSubmit = new ComSubmit();
